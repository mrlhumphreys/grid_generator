...
describe GridGenerator::Megaminx::FaceProjection do
  ...
  describe '#connecting_lines' do
    it 'should generate' do
      projection = GridGenerator::Megaminx::FaceProjection.new(x: 20, y: 20, units: 30)
      expected = [
        GridGenerator::BaseLine.new(y1: 77.29490168751578, x1: 170.0, x2: 20.0, y2: 77.29490168751578),
        GridGenerator::BaseLine.new(y1: 141.3525491562421, x1: 258.167787843871, x2: 123.64745084375788, y2: 141.3525491562421),
        GridGenerator::BaseLine.new(y1: 245.0, x1: 224.49068960040208, x2: 291.3525491562421, y2: 245.0),
        GridGenerator::BaseLine.new(y1: 245.0, x1: 115.50931039959795, x2: 291.3525491562421, y2: 245.0), 
        GridGenerator::BaseLine.new(y1: 141.35254915624213, x1: 81.83221215612903, x2: 123.64745084375792, y2: 141.35254915624213)
      ] 
